...
void problem_01(int id, char *name);
/*
Problem 2:
...
void problem_02(int id, char *name);
...
void problem_05(int id, char *name);
...
void problem_06(int id, char *name);
...
void problem_07(int id, char *name);
...
void problem_08(int id, char *name);
